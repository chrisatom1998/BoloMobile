...
export function JournalMotif({ accessibilityLabel, size = 'corner', style }: JournalMotifProps) {
  ...
  return (
    <View accessible={false} importantForAccessibility="no-hide-descendants" pointerEvents="none" style={[styles.motif, styles[`motif${size.charAt(0).toUpperCase()}${size.slice(1)}` as 'motifCorner'], style]}>
